                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h2 font-weight-bold mb-0">CRM</span>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <a href="#">
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Sistema</h5>
                                        <span class="h2 font-weight-bold mb-0">Configuración</span>
                                    </div>
                                    <div class="col-auto">
